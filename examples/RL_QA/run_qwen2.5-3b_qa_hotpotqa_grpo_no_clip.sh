...
# ============================================================
# verl GRPO Example: Qwen2.5-3B-Instruct (QA-EM / HotpotQA) - NO CLIP ABLATION
# - 基于 examples/RL_QA/run_qwen2.5-3b_qa_hotpotqa_grpo.sh
# - 与原始版本配置对齐，仅强制关闭 clip（同时取消 dual-clip）
# - 依赖 core_algos.py: actor.disable_clip=True
# ============================================================
...
#   bash run_qwen2.5-3b_qa_hotpotqa_grpo_no_clip.sh <MODEL_PATH_OR_NAME> [hydra_overrides...]
...
exp_name="${EXP_NAME:-qwen2.5_3b_hotpotqa_em_grpo_epochs_${ppo_epochs}_no_clip}"
...
# IS（非 no-IS，保持与 math_grpo.sh 对应：True）
...
echo "============================================================"
echo "[verl][GRPO] Qwen2.5-3B (QA-EM HotpotQA) - NO CLIP"
