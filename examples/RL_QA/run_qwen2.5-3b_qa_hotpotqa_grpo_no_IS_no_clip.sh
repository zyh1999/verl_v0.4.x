...
# ============================================================
# verl GRPO Example: Qwen2.5-3B-Instruct (QA-EM / HotpotQA) - NO-IS + NO CLIP ABLATION
# - 基于 examples/RL_QA/run_qwen2.5-3b_qa_hotpotqa_grpo_no_IS.sh
# - 与原始 no-IS 版本配置对齐，仅强制关闭 clip（同时取消 dual-clip）
# - 依赖 core_algos.py:
#   - actor.use_importance_sampling=False
#   - actor.disable_clip=True
# ============================================================
...
#   bash run_qwen2.5-3b_qa_hotpotqa_grpo_no_IS_no_clip.sh <MODEL_PATH_OR_NAME> [hydra_overrides...]
...
exp_name="${EXP_NAME:-qwen2.5_3b_no_IS_hotpotqa_em_grpo_epochs_${ppo_epochs}_no_clip}"
...
# clip（参数保持不变，但会通过 disable_clip=True 完全不生效）
...
echo "============================================================"
echo "[verl][GRPO] Qwen2.5-3B (QA-EM HotpotQA) - NO-IS + NO CLIP"
