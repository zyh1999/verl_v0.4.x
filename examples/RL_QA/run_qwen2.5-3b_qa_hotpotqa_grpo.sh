...
# - 对应 examples/grpo_trainer/run_qwen2.5-3b_math_grpo.sh（非 no-IS 版本）
# - 基于 examples/RL_QA/run_qwen2.5-3b_qa_hotpotqa_grpo_no_IS.sh
# - 除 use_importance_sampling 默认值（True）外，其余训练超参数保持不变
...
#   bash run_qwen2.5-3b_qa_hotpotqa_grpo.sh <MODEL_PATH_OR_NAME> [hydra_overrides...]
...
exp_name="${EXP_NAME:-qwen2.5_3b_hotpotqa_em_grpo_epochs_${ppo_epochs}}"
